...
$query = "INSERT INTO petfruitmv(rating) VALUES ('1')";
$result = mysqli_query($conn,$query);

$db2 = mysqli_connect("54.193.22.204","tester","password","project_281");
$sql = "INSERT INTO tracking VALUES(0,'Petcake','Pet Fruit Tarts')";
$db2->query($sql);
?>
<html>
<head>
        <h1 style="color: white; margin-left: 45%; top: 5px; position: relative;">Fruit Tarts</h1>
...
<meta name="viewport" content="width=device-width"> 
    ...
    <!-- rating star css -->
    <link rel="stylesheet" href="/petfruit/js/ratingstar.css">
<style>
body {
...
<body>
<div class="container">
<img class="alignnone size-medium wp-image-166" src="http://hejiang10937.ipage.com/wp-content/uploads/2018/11/fruit-300x300.jpg" alt="" width="101%" /></div>

<div class = "text">Delicious and healthy fruit tarts for your little one!
<br>
Please call or check our social media for daily/seasonal flavors.
<br><br>
...
<div class="numberRating" style="font-size: 20px; position: relative; left: 700px;">
            ...
            <div style="margin-top: -40px; margin-left: 280px;">
                <?php foreach (range(1,5) as $rating): ?>
                    <a href="/petfruit/rate.php?rating=<?php echo $rating; ?>"><?php echo $rating."&nbsp"; ?></a>
                <?php endforeach ?>
            </div>
    </div>
<div style="border-style: dotted; border-color: #f38067; margin-top: 0px; height: 140px; width: 500px; margin-left: 900px;">
        <h3 style="color: black; margin-left: 320px; text-shadow: 1px 1px;">Price: $5</h3><br>
        ...
        <?php
            if(isset($_POST['cart'])){
                $conn = mysqli_connect("54.193.22.204","tester","password","project_281");
                $query = "INSERT INTO shopping_cart (name, price, image) VALUES ('Pet Fruit Tarts', 5, 'petfruit.jpg')";
                $result = mysqli_query($conn,$query);
            }
        ?>
    </div>
...
<script src="/petfruit/js/ratingstar.js"></script>
<!-- ajax -->
<script>
// rating
var rate;
