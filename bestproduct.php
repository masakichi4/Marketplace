...
<html>
<head>
<title>Mostly Visited Products</title>
...
<br>
<br>
		<h3 style="color: black; margin-left: 20px; top: 20px; position: relative;">Mostly Visited Products</h3>
	</div>
	<br><br>
	<div style="margin-left: 50px; color: black; margin-top: -330px;">
		...
		$query1 = "SELECT SUM(rating) as rating FROM biscuitsmv;";
		...
		$query2 = "SELECT SUM(rating) as rating FROM petbrowniesmv;";
		...
		$query3 = "SELECT SUM(rating) as rating FROM petcandiesmv;";
		...
		$query4 = "SELECT SUM(rating) as rating FROM petcustomizedmv;";
		...
		$query5 = "SELECT SUM(rating) as rating FROM petcupcakesmv;";
		...
		$query6 = "SELECT SUM(rating) as rating FROM petdonutsmv;";
		...
		$query7 = "SELECT SUM(rating) as rating FROM petfruitmv;";
		...
		$query8 = "SELECT SUM(rating) as rating FROM peticemv;";
		...
		$query9 = "SELECT SUM(rating) as rating FROM petmacaronsmv;";
		...
		$query10 = "SELECT SUM(rating) as rating FROM petothermv;";
