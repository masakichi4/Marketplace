...
$sql = "INSERT INTO tracking VALUES(0,'Petcake','Pet Brownies')";
$db2->query($sql);

setcookie($product_name, (string)$product_val, time() + (86400 * 30), "/");
$conn = mysqli_connect('54.193.22.204','tester','password','project_281');
$query = "INSERT INTO petbrowniesmv(rating) VALUES ('1')";
$result = mysqli_query($conn,$query);
?>
<html>
<head>
    <h1 style="color: white; margin-left: 45%; top: 5px; position: relative;">Brownies</h1>
<meta name="viewport" content="width=device-width"> 
    ...
    <!-- rating star css -->
    <link rel="stylesheet" href="/petbrownies/js/ratingstar.css">
<style>
body {
...
<body>
    <div class="container">
        <img class="size-medium wp-image-80 alignright" src="http://hejiang10937.ipage.com/wp-content/uploads/2018/11/brownie-200x300.jpg" alt="Brownies" width="101%"/></div>
    <div class = "text">$5 each piece.
    <br>
    Vegan / nut-free options available!
    <br><br>
...
<div class="numberRating" style="font-size: 20px; position: relative; left: 700px;">
            ...
            <div style="margin-top: -40px; margin-left: 280px;">
                <?php foreach (range(1,5) as $rating): ?>
                    <a href="/petbrownies/rate.php?rating=<?php echo $rating; ?>"><?php echo $rating."&nbsp"; ?></a>
                <?php endforeach ?>
            </div>
    </div>
<div style="border-style: dotted; border-color: #f38067; margin-top: 0px; height: 140px; width: 500px; margin-left: 900px;">
        ...
        <?php
            if(isset($_POST['cart'])){
                $conn = mysqli_connect("54.193.22.204","tester","password","project_281");
                $query = "INSERT INTO shopping_cart (name, price, image) VALUES ('Pet Brownies', 5, 'petbrownies.jpg')";
                $result = mysqli_query($conn,$query);
            }
        ?>
    </div>
...
<script src="/petbrownies/js/ratingstar.js"></script>
<!-- ajax -->
<script>
// rating
var rate;
