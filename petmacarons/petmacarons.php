...
$query = "INSERT INTO petmacaronsmv(rating) VALUES ('1')";
$result = mysqli_query($conn,$query);
$db2 = mysqli_connect("54.193.22.204","tester","password","project_281");
$sql = "INSERT INTO tracking VALUES(0,'Petcake','Pet Macarons')";
$db2->query($sql);
?>
<html>
<head>
    <h1 style="color: white; margin-left: 45%; top: 5px; position: relative;">Macarons</h1>
...
<meta name="viewport" content="width=device-width"> 
    ...
    <!-- rating star css -->
    <link rel="stylesheet" href="/petmacarons/js/ratingstar.css">
<style>
body {
...
<body>
<div class="container">
    <img class="size-medium wp-image-72 alignright" src="http://hejiang10937.ipage.com/wp-content/uploads/2018/11/mocarons-240x300.jpg" alt="" width="102%"/></div>

<div class = "text">Photogenic, delicious, and speechlessly perfect.
<br>
$20 for three (comes with a ribbon).
<br><br>
...
<div class="numberRating" style="font-size: 20px; position: relative; left: 700px;">
            ...
            <div style="margin-top: -40px; margin-left: 280px;">
                <?php foreach (range(1,5) as $rating): ?>
                    <a href="/petmacarons/rate.php?rating=<?php echo $rating; ?>"><?php echo $rating."&nbsp"; ?></a>
                <?php endforeach ?>
            </div>
    </div>
<div style="border-style: dotted; border-color: #f38067; margin-top: 0px; height: 140px; width: 500px; margin-left: 900px;">
        <h3 style="color: black; margin-left: 320px; text-shadow: 1px 1px;">Price: $20</h3><br>
        ...
        <?php
            if(isset($_POST['cart'])){
                $conn = mysqli_connect("54.193.22.204","tester","password","project_281");
                $query = "INSERT INTO shopping_cart (name, price, image) VALUES ('Pet Macarons', 20, 'petmacarons.jpg')";
                $result = mysqli_query($conn,$query);
            }
        ?>
    </div>
...
<script src="/petmacarons/js/ratingstar.js"></script>
<!-- ajax -->
<script>
// rating
var rate;
