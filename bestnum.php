...
<div class="body" style="background-colour:	#F0E68C; height: 180px; margin-top: -50px;">
	...
	<div style="margin-left: 50px; color: black; margin-top: -330px;">
		...
		$query1 = "SELECT AVG(rating) as rating FROM biscuitsnum;";
		...
		$query2 = "SELECT AVG(rating) as rating FROM petbrowniesnum;";
		...
		$query3 = "SELECT AVG(rating) as rating FROM petcandiesnum;";
		...
		$query4 = "SELECT AVG(rating) as rating FROM petcustomizednum;";
		...
		$query5 = "SELECT AVG(rating) as rating FROM petcupcakesnum;";
		...
		$query6 = "SELECT AVG(rating) as rating FROM petdonutsnum;";
		...
		$query7 = "SELECT AVG(rating) as rating FROM petfruitnum;";
		...
		$query8 = "SELECT AVG(rating) as rating FROM peticenum;";
		...
		$query9 = "SELECT AVG(rating) as rating FROM petmacaronsnum;";
		...
		$query10 = "SELECT AVG(rating) as rating FROM petothernum;";
		$result = mysqli_query($conn,$query10);

		foreach ($result as $row) {
			$bestrating["Pet OtherDesserts"] = round($row["rating"],2);
		}
	...
	?>
      ...
      function drawChart() {
        ...
        var options = {
          title: 'Best Number Rated Products'
        };
